...
const topics: Topic[] = [
  ...
  ["O que o Experimento da Prisão de Stanford realmente demonstra?", "Experimentos", "Experimento", "Desafio", "Analise o desenho do estudo de Philip Zimbardo, suas conclusões sobre papéis sociais e as críticas metodológicas e éticas posteriores.", "stanford"],
  ["Obediência à autoridade no Experimento de Milgram", "Experimentos", "Experimento", "Explique o conflito entre consciência individual e autoridade institucional no estudo de Stanley Milgram, incluindo seus limites éticos.", "milgram"],
  ["Conformidade social no Experimento de Asch", "Experimentos", "Experimento", "Mostre como a pressão de um grupo pode afetar uma resposta aparentemente óbvia e diferencie conformidade pública de convicção privada.", "asch"],
  ["O Pequeno Albert e a história do condicionamento", "Experimentos", "Experimento", "Examine o estudo de John Watson e Rosalie Rayner, seu impacto na psicologia comportamental e os problemas de consentimento e proteção infantil.", "pequeno-albert"],
  ["Robbers Cave: quando grupos entram em conflito", "Experimentos", "Experimento", "Analise como competição, identidade de grupo e metas compartilhadas foram usados para estudar conflito e cooperação entre grupos.", "robbers-cave"],
  ["A sala monocromática de John Lilly", "Experimentos", "Experimento", "Investigue relatos sobre isolamento e privação sensorial associados a John Lilly, separando evidência documentada, interpretação e mito.", "lilly"],
  ["Os macacos de pano de Harry Harlow", "Experimentos", "Experimento", "Explique o que os estudos de Harlow sugeriram sobre vínculo e conforto, discutindo sofrimento animal e como a ética científica mudou.", "harlow"],
  ["O Experimento do Monstro", "Experimentos", "Experimento", "Examine o estudo de Wendell Johnson sobre gagueira, seus objetivos e por que ele se tornou um caso emblemático de dano em pesquisa.", "monstro"],
  ["Abuso de drogas em macacos: o estudo de 1969", "Experimentos", "Experimento", "Contextualize os estudos de auto-administração de drogas em primatas e discuta o que eles podem — e não podem — dizer sobre dependência humana.", "drogas-1969"],
  ["A Terceira Onda e a sedução do autoritarismo", "Experimentos", "Experimento", "Analise a experiência escolar de Ron Jones, seus objetivos pedagógicos e o debate sobre sua documentação e sua classificação como experimento.", "terceira-onda"],
  ["Rosenhan: pessoas sãs em lugares insanos", "Experimentos", "Experimento", "Discuta o estudo de David Rosenhan sobre diagnóstico psiquiátrico, suas repercussões e as contestações de seus dados.", "rosenhan"],
  ["Projetos secretos de aversão na África do Sul", "Experimentos", "Experimento", "Investigue abusos de psiquiatria e coerção durante o apartheid, enfatizando poder institucional, violência e responsabilidade científica.", "aversao-africa-sul"],
  ["Desamparo aprendido e a caverna de Seligman", "Experimentos", "Experimento", "Explique como Martin Seligman formulou a hipótese do desamparo aprendido e discuta a diferença entre modelo experimental e experiência humana.", "seligman"],
  ["O efeito espectador de Darley e Latané", "Experimentos", "Experimento", "Analise como presença de outras pessoas, difusão de responsabilidade e interpretação da situação afetam a decisão de ajudar.", "bystander"],
  ["O caso Genovese e o mito do espectador", "Experimentos", "Experimento", "Compare a narrativa jornalística sobre Kitty Genovese com o que pesquisas posteriores revelaram sobre o chamado efeito espectador.", "genovese"],
  ["A Boneca Bobo de Albert Bandura", "Experimentos", "Experimento", "Explique o estudo sobre aprendizagem por observação e discuta como imitação, contexto e mídia se relacionam com comportamento agressivo.", "bobo"],
  ["O gorila invisível de Simons e Chabris", "Experimentos", "Experimento", "Mostre como o desvio de atenção desafia a confiança que temos na própria percepção e quais fatores mudam o resultado.", "gorila-invisivel"],
  ["Privação sensorial na Universidade McGill", "Experimentos", "Experimento", "Investigue os estudos de Donald Hebb sobre isolamento perceptivo e discuta efeitos psicológicos, limites e consentimento.", "mcgill"],
  ["A privação de sono de Randy Gardner", "Experimentos", "Experimento", "Analise o recorde de vigília de Randy Gardner, seus efeitos observados e por que relatos históricos não equivalem a um ensaio controlado.", "randy-gardner"],
  ["Universo 25 de John B. Calhoun", "Experimentos", "Experimento", "Explique o estudo populacional com camundongos e discuta por que suas conclusões não devem ser transferidas diretamente para cidades humanas.", "universo-25"],
  ["A linha de montagem de Hawthorne", "Experimentos", "Experimento", "Analise os estudos de produtividade da Western Electric e o chamado efeito Hawthorne, incluindo as revisões históricas sobre seus dados.", "hawthorne"],
  ["O teste do marshmallow de Walter Mischel", "Experimentos", "Experimento", "Discuta autocontrole, espera por recompensa e as limitações das interpretações populares sobre sucesso futuro.", "marshmallow"],
  ["A falsa memória de Loftus e Palmer", "Experimentos", "Experimento", "Explique como a formulação de uma pergunta pode alterar lembranças de um evento e quais consequências isso traz para testemunhos.", "loftus-palmer"],
  ["A cegueira por mudança de Simons", "Experimentos", "Experimento", "Investigue por que mudanças visuais grandes podem passar despercebidas e conecte atenção, memória e percepção.", "cegueira-mudanca"],
  ["O problema do bonde e os dilemas morais", "Experimentos", "Experimento", "Compare variações do dilema do bonde e avalie o que pesquisas experimentais conseguem revelar — ou simplificar demais — sobre moralidade.", "bonde"],
  ["O jogo do ultimato", "Experimentos", "Experimento", "Analise como pessoas dividem recursos, reagem à injustiça e negociam sob regras diferentes.", "ultimato"],
  ["O jogo dos bens públicos", "Experimentos", "Experimento", "Explique a tensão entre interesse individual e cooperação coletiva em experimentos de contribuição para um recurso comum.", "bens-publicos"],
  ["O viés de confirmação em Wason", "Experimentos", "Experimento", "Mostre como pessoas testam regras de modo enviesado e por que buscar evidências contrárias é tão difícil.", "wason"],
  ["O efeito placebo e o poder da expectativa", "Experimentos", "Experimento", "Explique como expectativa, contexto e relação de cuidado podem influenciar sintomas, sem confundir placebo com cura universal.", "placebo"],
  ["O experimento da boneca de Clark", "Experimentos", "Experimento", "Analise como crianças racializadas reagiam a bonecas diferentes e discuta identidade, racismo internalizado e limites de interpretação.", "clark"],
  ["A caverna de Platão como experimento mental", "Experimentos", "Experimento", "Use a alegoria da caverna para refletir sobre percepção, educação e resistência à mudança de crenças.", "platao"],
  ["O quarto chinês de John Searle", "Experimentos", "Experimento", "Apresente o experimento mental e discuta se manipular símbolos é suficiente para compreender uma linguagem.", "quarto-chines"],
  ["O cérebro em uma cuba", "Experimentos", "Experimento", "Investigue o experimento mental sobre realidade e conhecimento, conectando-o a simulações digitais e ceticismo filosófico.", "cuba"],
  ["O gato de Schrödinger", "Experimentos", "Experimento", "Explique por que o gato é um experimento mental sobre interpretação da mecânica quântica — não um protocolo para realizar em animais.", "schrodinger"],
  ["A dupla fenda e o papel da observação", "Experimentos", "Experimento", "Descreva o fenômeno da dupla fenda em linguagem acessível e diferencie observação física de interpretações místicas.", "dupla-fenda"],
  ["O efeito Dunning-Kruger", "Experimentos", "Experimento", "Analise a relação entre habilidade, metacognição e confiança, evitando transformar um resultado estatístico em rótulo para pessoas.", "dunning-kruger"],
  ["A obediência destrutiva em Hofling", "Experimentos", "Experimento", "Compare o estudo hospitalar de Charles Hofling com Milgram e discuta como contexto profissional altera a obediência.", "hofling"],
  ["A prisão de BBC e a replicação de Haslam e Reicher", "Experimentos", "Experimento", "Compare a BBC Prison Study com Stanford e discuta liderança, identidade social e replicabilidade.", "bbc-prison"],
  ["A economia da confiança no jogo do investimento", "Experimentos", "Experimento", "Explore como confiança e reciprocidade aparecem quando participantes enviam recursos a desconhecidos.", "confianca"],
  ["O experimento de Asch com variações culturais", "Experimentos", "Experimento", "Investigue como tamanho do grupo, unanimidade e contexto cultural alteram a conformidade.", "asch-cultura"],
  ["O efeito de mera exposição de Zajonc", "Experimentos", "Experimento", "Explique por que a familiaridade pode aumentar a preferência e discuta quando repetição não significa qualidade.", "mera-exposicao"],
